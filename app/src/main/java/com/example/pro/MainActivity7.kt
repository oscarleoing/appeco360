...
class MainActivity7  : AppCompatActivity(), OnMapReadyCallback {
    ...
    // 👉 contenedor del formulario (pantalla 2 integrada)
    private lateinit var layoutPantalla2: LinearLayout
    ...
    companion object {
        ...
        private const val TAG = "MainActivity7"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            layoutPantalla2 = findViewById(R.id.layoutPantalla2)
        ...
        mapFragment?.view?.let { mapView ->
            mapView.animate()
                ...
                .withEndAction {
                    ...
                    // 👇 Mostrar el formulario integrado
                    layoutPantalla2.alpha = 0f
                    layoutPantalla2.visibility = View.VISIBLE
                    layoutPantalla2.animate().alpha(1f).setDuration(400).start()
                }
                .start()
        }
    ...
    private fun mostrarMapaYBotones() {
        ...
        layoutPantalla2.animate()
            .alpha(0f)
            .setDuration(400)
            .withEndAction {
                layoutPantalla2.visibility = View.GONE
            }
            .start()
    }
